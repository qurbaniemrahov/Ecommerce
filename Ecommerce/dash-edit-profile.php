...
<body class="config">
                                ...
                                <div class="col-lg-9 col-md-12">
                                    <div class="dash__box dash__box--shadow dash__box--radius dash__box--bg-white">
                                        <div class="dash__pad-2">
                                            ...
                                            <span class="dash__text u-s-m-b-30">Update your account email or password.</span>
                                            <div class="u-s-m-b-30" id="profile-status" style="display:none;"></div>
                                            <div class="dash__link dash__link--secondary u-s-m-b-30">

                                                <a data-modal="modal" data-modal-id="#dash-newsletter">Subscribe Newsletter</a></div>
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <form class="dash-edit-p" action="../Admin/app/Http/Controllers/signup/profile_update_controller.php" method="POST">
                                                        ...
                                                        <div class="gl-inline">
                                                            ...
                                                            <div class="u-s-m-b-30">
                                                                ...
                                                                <input class="input-text input-text--primary-style" type="password" id="new-password" name="new_password" placeholder="New password" minlength="6" required>
                                                            </div>
                                                        </div>
                                                        <div class="u-s-m-b-30">

                                                            <label class="gl-label" for="confirm-password">CONFIRM NEW PASSWORD *</label>

                                                            <input class="input-text input-text--primary-style" type="password" id="confirm-password" name="confirm_password" placeholder="Confirm new password" minlength="6" required>
                                                        </div>
    ...
    <script>
        (function () {
            var messages = {
                updated: 'Your email and password were updated successfully.',
            ...
            var box = document.getElementById('profile-status');

            if (status && messages[status] && box) {
                box.textContent = messages[status];
                box.style.display = 'block';
                box.style.padding = '12px 16px';
                box.style.borderRadius = '4px';
                box.style.color = status === 'updated' ? '#155724' : '#721c24';
                box.style.background = status === 'updated' ? '#d4edda' : '#f8d7da';
                box.style.border = status === 'updated' ? '1px solid #c3e6cb' : '1px solid #f5c6cb';
            }
        }());
    </script>
