...
<body class="config">
                            ...
                            <div class="breadcrumb__wrap">
                                <ul class="breadcrumb__list">
                                    ...
                                    <li class="is-marked">
                                        ...
                                        <a href="reset-password.php">Reset</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-6 col-md-8 u-s-m-b-30">
                                <div class="l-f-o">
                                    <div class="l-f-o__pad-box">
                                        <h1 class="gl-h1">CREATE NEW PASSWORD</h1>

                                        <span class="gl-text u-s-m-b-30">Choose a new password for your account and confirm it below.</span>
                                        <form class="l-f-o__form" id="create-password-form">
                                            <div class="u-s-m-b-30">

                                                <label class="gl-label" for="reset-email">E-MAIL *</label>

                                                <input class="input-text input-text--primary-style" type="email" id="reset-email" placeholder="Enter E-mail" readonly></div>
                                            <div class="u-s-m-b-30">

                                                <label class="gl-label" for="new-password">NEW PASSWORD *</label>

                                                <input class="input-text input-text--primary-style" type="password" id="new-password" placeholder="Enter New Password" required></div>
                                            <div class="u-s-m-b-30">

                                                <label class="gl-label" for="confirm-password">CONFIRM PASSWORD *</label>

                                                <input class="input-text input-text--primary-style" type="password" id="confirm-password" placeholder="Confirm New Password" required></div>
                                            <div class="u-s-m-b-30">

                                                <button class="btn btn--e-transparent-brand-b-2" type="submit">SAVE NEW PASSWORD</button></div>
                                            <div class="u-s-m-b-30">

                                                <a class="gl-link" href="signin.html">Back to Login</a></div>
                                        </form>
                                        <div class="reset-demo-box" id="password-updated-box" style="display:none; padding:24px; border:1px solid #e5e5e5; border-radius:6px; background:#f8fbff;">
                                            <div class="reset-demo-box__icon" style="font-size:32px; color:#28a745; margin-bottom:12px;"><i class="fas fa-check-circle"></i></div>
                                            <h2 class="gl-h2 u-s-m-b-15">Password Updated</h2>
                                            <p class="gl-text u-s-m-b-25">Front-end demo olaraq sifren ugurla yenilendi goruntusu gosterilir. Back-end hazir olanda bu addim real emeliyyata baglana biler.</p>
                                            <a class="btn btn--e-brand-b-2" href="signin.php">GO TO SIGN IN</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        (function () {
            ...
            var successBox = document.getElementById('password-updated-box');

            if (emailInput) {
                emailInput.value = params.get('email') || 'customer@example.com';
            }

            if (!form || !newPassword || !confirmPassword || !successBox) {
                return;
            }
