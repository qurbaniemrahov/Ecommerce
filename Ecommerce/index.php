...
foreach ($sliders as &$slider) {
    ...
    $slider['image_url'] = $imagePath !== '' ? $imagePath : 'images/slider/slide-1.jpg';
}
unset($slider);
?>
...
<div class="slider">
            ...
            <?php foreach($sliders as $slide): ?>
                <div class="slide-item">
                    ...
                    <div class="slide-caption">
                        ...
                        <p>Admin panelden elave olunan slider indi bu ana sehifede tam gorunur.</p>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
    ...
    <?php else: ?>
        <div class="slider-empty">
            <div>
                <h2>No active slider found</h2>
                <p>Admin panelden aktiv banner elave etdikden sonra burada gosterilecek.</p>
            </div>
        </div>
    <?php endif; ?>
</div>
