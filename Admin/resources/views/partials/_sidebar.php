      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <!-- <a class="sidebar-brand brand-logo" href="../index.html"><img src="../assets/images/logo.svg" alt="logo" /></a> -->
           <h2>Admin panel</h2>
          <a class="sidebar-brand brand-logo-mini" href="/Ecommerce/Admin/public/index.php"><img src="../resources/assets/images/logo-mini.svg" alt="logo" /></a>
        </div>
        <ul class="nav">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="navbar p-0 fixed-top d-flex flex-row">
          <div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
            <a class="navbar-brand brand-logo-mini" href="/Ecommerce/Admin/public/index.php"><img src="../resources/assets/images/logo-mini.svg" alt="logo" /></a>
          </div>
