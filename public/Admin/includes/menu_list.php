...
include('../controller/admin_menu.php');
?>
<head>
    ...
    <div class="row">
        <div class="col-12">
                ...
                <div class="card-body">
                    <div class="col-sm-4">
                        <a href="./menu_create" class="btn btn-danger mb-2">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-centered w-100 dt-responsive nowrap" method="GET" action="../includes/menu_create.php">
            ...
            if (!empty($result_menu)) {
                foreach ($result_menu as $row) {
                    ...
                    <tr>
                        ...
                        <td>
                            <p><?php echo $row['menu_title']; ?></p>
                            
                        </td>
                        <td>
<form action="../login/menu_delete?id=<?php echo $row['id']; ?>" method = "POST">
 
<button onclick="confirmDeleteUser(<?php echo $row['id']; ?>)"   name="menu_delete" value = "" class="btn btn-danger">Delete</button>
</form>
</td>
                    </tr>
                    <?php
