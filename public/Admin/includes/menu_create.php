...
?>
    ...
    <div class="row">
        <div class="col-12">
                        ...
                        <div class="card">
                <div class="card-body">
                    <form action="menu_controll" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="tab-pane show active  " id="home1">
                                                            ...
                                                            <div >
                                                                ...
                                                                <input type="text" id="title" class="form-control"
                                                                       placeholder="Başlıq" name="menu_name" 
                                                                       value="">
                                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="mb-3">
                                                        ...
                                                        <div class="col-xl-12 d-flex justify-content-flex-end">
                                                            <button name="menu_add"  class="btn btn-primary">Saxla</button>
                                                        </div>
                                        </div>
                                    </div>
                                </div>
